    ...
    class ArenaManager {
        ...
        */
        ...
        createExitPopUpNew() {
            ...
            const playerName = "ABC" ;//this.playerList[topPlayerId].name;
            const playerIdWin = "11";//userDataPlayer[0].players[topPlayerId].id;
            const game_id = 2;//userDataPlayer[0].players[topPlayerId].offline_game_id;
        ...
        async onTokenReached(data) {
            ...
            const player_id = 11;//userDataPlayer[0].players[data._content.pid].id;
            const token_id = data._content.tid;
            const dice_value = currentDiceValue;
            const game_id = 2;//userDataPlayer[0].players[data._content.pid].offline_game_id
