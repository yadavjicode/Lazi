...
class CheckBalanceController extends GetxController {
  ...
  Future<void> checkBalance(BuildContext context, String tournamentId,
      String noOfPlayer, String tournmentTime) async {
    isLoading.value = true;
    _error = null;

    try {
      _member = await apiService.checkBalance(tournamentId);
