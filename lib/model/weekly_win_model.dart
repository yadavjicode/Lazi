class WeeklyWinModel {
  List<Weekly>? weeklyList;
  String? message;
  bool? status;

  WeeklyWinModel({this.weeklyList, this.message, this.status});

  WeeklyWinModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      weeklyList = <Weekly>[];
      json['data'].forEach((v) {
        weeklyList!.add(new Weekly.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.weeklyList != null) {
      data['data'] = this.weeklyList!.map((v) => v.toJson()).toList();
    }
