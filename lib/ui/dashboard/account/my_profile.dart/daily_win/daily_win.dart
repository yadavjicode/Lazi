...
import 'package:ludonew/controller/daily_win_controller.dart';
import 'package:ludonew/util/comman_code/comman_code.dart';
import 'package:ludonew/util/constant/contant_color.dart';
import 'package:ludonew/widgets/font.dart';

class DailyWin extends StatefulWidget {
  const DailyWin({super.key});

  @override
  State<DailyWin> createState() => _DailyWinState();
}

class _DailyWinState extends State<DailyWin> {
  final DailyWinController dailyWinController = Get.put(DailyWinController());
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      dailyWinController.dailyWin(context);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(children: [
        ...
        Obx(() {
          if (dailyWinController.isLoading.value) {
            return Center(
            ...
            return Padding(
                ...
                child: ListView.builder(
                    ...
                    itemCount: dailyWinController.dailyList.length,
                    padding: EdgeInsets.symmetric(vertical: 16),
                    itemBuilder: (context, index) {
                      final item = dailyWinController.dailyList[index];
                      return Container(
